...
/* 机械臂关节数量（引用 Arm_Task.h 的宏来保证一致性）*/
...
extern  void DJI_Motor_Send_0x1FF(FDCAN_TxFrame_TypeDef *FDCAN_TxFrame, int16_t motor1_v, int16_t motor2_v, int16_t motor3_v, int16_t motor4_v);
